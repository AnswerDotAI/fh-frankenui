...
def MakeTaskForm():
    return Card(Form(id='createTaskForm')(
             ...
             Div(cls='grid grid-cols-2')(
                UkButton(cls=(UkButtonT.ghost))('Cancel'),
...
@app.get('/')
def homepage():
    return MakeTaskForm(),Div(cls='p-8')(
        ...
        Div(cls='mt-8 flex items-center justify-between')(
                 Div(cls='flex flex-1 gap-4')(
                    ...
                    UkButton('Create Task',cls='uk-button-primary text-xs font-medium'))),
