...
Right2 = Card(H4(cls='uk-h4')("franken/ui"),
              P(cls='text-sm uk-text-muted')("HTML-first, framework-agnostic, beautifully designed components that you can truly copy and paste into your site. Accessible. Customizable. Open Source."),
              Div(cls='flex space-x-4 text-sm uk-text-muted')(
...
Right3 = Card(
    UkInput(label = Div(H4(cls='uk-h5')('Strictly Necessary'),P(cls='font-normal leading-snug uk-text-muted')('These cookies are essential in order to use the website and use its features.')),
                inp_cls='uk-toggle-switch uk-toggle-switch-primary flex-none',
                cls='flex items-center justify-between gap-2'),
    UkInput(label = Div(H4(cls='uk-h5')('Functional Cookies'),P(cls='font-normal leading-snug uk-text-muted')('These cookies allow the website to provide personalized functionality.')),
                inp_cls='uk-toggle-switch uk-toggle-switch-primary flex-none',
                cls='flex items-center justify-between gap-2'),
    UkInput(label = Div(H4(cls='uk-h5')('Performance Cookies'),P(cls='font-normal leading-snug uk-text-muted')('These cookies help to improve the performance of the website.')),
                inp_cls='uk-toggle-switch uk-toggle-switch-primary flex-none',
                cls='flex items-center justify-between gap-2'),
...
options = ((Div('Viewer'),Div(cls='text-sm uk-text-muted')('Can view and comment.',)),
        (Div('Developer'),Div(cls='text-sm uk-text-muted')('Can view, comment and edit.',)),
        (Div('Billing'),Div(cls='text-sm uk-text-muted')('Can view, comment and manage billing.',)),
        (Div('Owner'),Div(cls='text-sm uk-text-muted')('Admin-level to all resources.')),)
...
body = [Div(cls='flex items-center space-x-4')(
        ...
        Div(cls='flex-1')(
            ...
            P(member['email'], cls='text-sm uk-text-muted')
        ),
...
Middle1 = (Card(*body,
    body_cls='space-y-6',
    header = (H4('Team Members', cls='uk-h4'),Div('Invite your team members to collaborate.', cls='mt-1.5 text-sm uk-text-muted'))
))
...
body = [Div(cls='flex items-center space-x-4')(
    ...
    UkSelect(*[Option(o) for o in options],label=member['role']),
    # UkDropdownButton(member['role'], options, btn_cls=UkButtonT.default),
) for member in team_members]
...
Middle2 = Card(
    ...
    *body,
    body_cls='space-y-6',
    header = (H4('Share this document', cls='uk-h4'),Div('Anyone with the link can view this document.', cls='mt-1.5 text-sm uk-text-muted'))
)
...
Middle4 = Card(
    ...
    (
        *[Li(cls='-mx-1')(A(cls="", href='#demo', uk_toggle=True)(Div(cls="flex gap-x-4")(Div(uk_icon=icon),Div(cls='flex-1')(P(name),P(cls="text-sm uk-text-muted")(desc)))))
    ...
    #bell user ban
        header = (H4('Notification', cls='uk-h4'),Div('Choose what you want to be notified about.', cls='mt-1.5 text-sm uk-text-muted')),
        body_cls='pt-0'
)
