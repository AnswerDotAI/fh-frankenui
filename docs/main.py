...
def tutorial_app(request=None):
    ...
    content = Container(cls='space-y-4')(
        H1("Tutorial App"),
        P("This is a heavily commented example of a product gallery app built with fh-FrankenUI for those that like to learn by example."),
        P("This tutorial app assumes you have some familiarity with fasthtml apps already, and focuses on what fh-frankenui adds on top of fasthtml."),
        app_rendered)
    return _create_page(content, request, 'Getting Started')
