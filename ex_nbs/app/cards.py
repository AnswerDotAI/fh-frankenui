...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../02_cards.ipynb.

# %% auto 0
__all__ = ['Left1', 'Card1Svg', 'Card2Svg', 'AppleSvg', 'Left2', 'area_opts', 'severity_opts', 'Right1', 'FlexBlockCentered',
           'franken_desc', 'Right2', 'Right3', 'team_members', 'body', 'Middle1', 'access_roles', 'Middle2', 'Middle3',
