...
# %% auto 0
__all__ = ['sidebar_group1', 'sidebar_group2', 'mail_data', 'mail_homepage', 'NavItem', 'NavGroup', 'Sidebar', 'format_date',
           'MailItem', 'MailList', 'MailContent', 'IconNavItem', 'IconNav', 'MailDetailView']
