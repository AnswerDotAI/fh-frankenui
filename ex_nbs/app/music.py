# AUTOGENERATED! DO NOT EDIT! File to edit: ../05_music.ipynb.

# %% auto 0
__all__ = ['music_dd_data', 'edit_dd_data', 'music_items', 'file_dd_items', 'edit_actions', 'view_dd_data', 'account_dd_data',
           'music_headers', 'discover', 'library', 'playlist', 'listen_now_albums', 'made_for_you_albums',
           'music_content', 'tabs', 'discoved_data', 'library_data', 'playlists_data', 'sb', 'music_homepage',
           'wrap_in_a', 'MusicLi', 'AlbumImg', 'AlbumFooter', 'Album', 'create_album_grid', 'podcast_tab',
           'LAlignedIconTxts', 'MusicSidebarLi', 'page']
        ...
        NavBarNav(
            ...
            Li(A("Edit"),
                NavBarNavContainer(
                    *map(lambda x: MusicLi(*x), edit_actions),
                    Li(A(FullySpacedDiv("Smart Dictation", UkIcon("microphone", 0.5)))),
                    Li(A(FullySpacedDiv("Emojis & Symbols", UkIcon("world", 0.5)))))),
            Li(A("View"),
            ...
            Li(A("Account"),
                NavBarNavContainer(
                    ...
                    MusicLi("Andy"),
                    Li(A(LAlignedDiv(UkIcon("plus-circle", 0.5), P("Benoit"),cls='space-x-2'))),
                    MusicLi("Luis"),
...
sb = NavContainer(
    Div(NavHeaderLi(H3("Discover")),*[MusicSidebarLi(*o) for o in discoved_data],cls='space-y-4'),
    Div(NavHeaderLi(H3("Library")),*[MusicSidebarLi(*o) for o in library_data],cls='space-y-4'),
    Div(NavHeaderLi(H3("Playlists")),*[MusicSidebarLi(*o) for o in playlists_data],cls='space-y-4'),
    cls=(NavT.secondary,'space-y-8','px-8')
)
