...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'fh_frankenui.components': { 'fh_frankenui.components.Card': ('components.html#card', 'fh_frankenui/components.py'),
                                         ...
                                         'fh_frankenui.components.UkDropdownButton': ( 'components.html#ukdropdownbutton',
                                                                                       'fh_frankenui/components.py'),
                                         'fh_frankenui.components.UkFormLabel': ( 'components.html#ukformlabel',
                                                                                  'fh_frankenui/components.py'),
                                         ...
                                         'fh_frankenui.components.UkTextArea': ('components.html#uktextarea', 'fh_frankenui/components.py'),
