...
# %% auto 0
__all__ = ['TextT', 'TextFont', 'Alert', 'ButtonT', 'Button', 'H1', 'H2', 'H3', 'H4', 'UkHSplit', 'UkHLine', 'UkNavDivider',
           'Article', 'ArticleTitle', 'ArticleMeta', 'ContainerT', 'Container', 'SectionT', 'Section', 'Fieldset',
           'Legend', 'Input', 'Select', 'Radio', 'CheckboxX', 'Range', 'Toggle_switch', 'TextArea', 'Switch', 'LabelT',
           'Label', 'FormLabel', 'UkFormSection', 'LinkT', 'Link', 'ListT', 'List', 'ModalContainer', 'ModalDialog',
           'ModalHeader', 'ModalBody', 'ModalFooter', 'ModalTitle', 'ModalCloseButton', 'Modal', 'Nav',
           'NavBarContainer', 'NavBarNav', 'PaddingT', 'PositionT', 'Placeholder', 'Progress', 'Sticky', 'Theme',
           'UkIcon', 'DiceBearAvatar', 'UkIconButton', 'FlexT', 'GridT', 'Grid', 'ResponsiveGrid', 'FullySpacedDiv',
           'CenteredDiv', 'LAlignedDiv', 'RAlignedDiv', 'VStackedDiv', 'HStackedDiv', 'SpaceBetweenDiv',
           'GenericLabelInput', 'LabelInput', 'LabelRadio', 'LabelCheckboxX', 'LabelRange', 'LabelToggle_switch',
           'LabelTextArea', 'LabelSwitch', 'LabelSelect', 'Options', 'UkSelect', 'UkDropdownButton', 'UkNavbarDropdown',
           'UkNavbar', 'UkSidebar', 'NavTab', 'UkTab', 'CardT', 'CardTitle', 'CardHeader', 'CardBody', 'CardFooter',
...
# %% ../lib_nbs/01_core.ipynb
def Nav(*c, cls=(), **kwargs):             return fh.Ul(*c,  cls=('uk-nav',             stringify(cls)),                 **kwargs)
def NavBarContainer(*c, cls=(), **kwargs): return fh.Div(*c, cls=('uk-navbar-container',stringify(cls)), uk_navbar=True, **kwargs)
def NavBarNav(*c, cls=(), **kwargs):       return fh.Nav(*c, cls=('uk-navbar-nav',      stringify(cls)),                 **kwargs)
