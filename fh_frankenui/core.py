...
# %% auto 0
__all__ = ['enum_to_markdown_table', 'fast_app', 'FastHTML', 'Theme', 'TextT', 'TextFont', 'Alert', 'ButtonT', 'Button',
           'ButtonSubmit', 'H1', 'H2', 'H3', 'H4', 'Titled', 'DividerT', 'Divider', 'UkHSplit', 'UkHLine', 'Article',
