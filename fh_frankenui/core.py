...
# %% auto 0
__all__ = ['franken_class_map', 'enum_to_markdown_table', 'fast_app', 'FastHTML', 'Theme', 'TextT', 'TextFont', 'P', 'PLarge',
           'PLead', 'PSmall', 'PMuted', 'CodeSpan', 'blockquote', 'H1', 'H2', 'H3', 'H4', 'ButtonT', 'Button', 'Main',
           'ContainerT', 'Container', 'Titled', 'DividerT', 'Divider', 'DividerSplit', 'DividerLine', 'Article',
...
# %% ../nbs/01_core.ipynb
def P(*args, cls='uk-paragraph', **kwargs): 
    return fh.P(*args, cls=stringify(cls), **kwargs)
