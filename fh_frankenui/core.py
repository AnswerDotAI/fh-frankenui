...
# %% auto 0
__all__ = ['ButtonT', 'ContainerT', 'LabelT', 'LinkT', 'PaddingT', 'PositionT', 'SectionT', 'TextT', 'FlexT', 'CardT', 'TableT',
           'stringify', 'str2ukcls', 'VEnum', 'create_uk_enum', 'UkGenericComponent', 'H1', 'H2', 'H3', 'H4', 'Alert',
           'Article', 'ArticleTitle', 'ArticleMeta', 'Button', 'Container', 'Input', 'Select', 'Radio', 'CheckboxX',
           'Range', 'Toggle_switch', 'TextArea', 'Switch', 'Label', 'Link', 'List', 'ModalContainer', 'ModalDialog',
           'ModalHeader', 'ModalBody', 'ModalFooter', 'ModalTitle', 'ModalCloseButton', 'Modal', 'Nav',
           'NavBarContainer', 'NavBarNav', 'Placeholder', 'Progress', 'Section', 'Sticky', 'Theme', 'TextFont',
           'UkIcon', 'Img', 'DiceBearAvatar', 'Grid', 'ResponsiveGrid', 'FullySpacedDiv', 'CenteredDiv', 'LAlignedDiv',
           'RAlignedDiv', 'VStackedDiv', 'HStackedDiv', 'SpaceBetweenDiv', 'GenericLabelInput', 'LabelInput',
           'LabelRadio', 'LabelCheckboxX', 'LabelRange', 'LabelToggle_switch', 'LabelTextArea', 'LabelSwitch',
           'LabelSelect', 'UkIconButton', 'Options', 'UkSelect', 'UkDropdownButton', 'UkHSplit', 'UkHLine',
           'UkNavDivider', 'UkNavbarDropdown', 'UkNavbar', 'UkSidebar', 'NavTab', 'UkTab', 'CardTitle', 'CardHeader',
           'CardBody', 'CardFooter', 'CardContainer', 'Card', 'Table', 'Td', 'Th', 'Tr', 'Thead', 'Tbody',
...
def Switch(*c, cls=(), **kwargs):
    return UkGenericComponent(CheckboxX, *c, cls=('uk-toggle-switch uk-form-switch',stringify(cls)), **kwargs)
...
def ModalCloseButton(*c, cls=(), **kwargs):
    return UkGenericComponent(fh.Button, *c, cls=('uk-modal-close',stringify(cls)), type='button', **kwargs)
...
def Modal(*c,
    ...
    return ModalContainer(ModalDialog(cls, **kwargs)(*res))
...
def GenericLabelInput(
    ...
    if isinstance(label, str) or label.tag != 'label': 
        label = Label(lbl_cls=stringify(lbl_cls), fr=id)(label)
