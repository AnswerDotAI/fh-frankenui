...
# Add cells
cells = [
    nbf.v4.new_markdown_cell("# Theme Definitions and Mappings\n\n> Theme variables and mappings between FrankenUI and DaisyUI themes"),
    nbf.v4.new_code_cell("#| default_exp themes"),
    nbf.v4.new_code_cell("#| hide\nfrom nbdev.showdoc import *"),
...
# Write the notebook
nbf.write(nb, "nbs/02_themes.ipynb")
